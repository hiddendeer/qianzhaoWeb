  ...
  <el-container>
    ...
    <el-main class="nopadding">
      ...
      <div class="scTable-page !justify-end">
        <el-pagination background :small="true" layout="total, sizes, prev, pager, next" :total="dataObj.total"
            :page-sizes="[20, 30]" v-model:currentPage="searchForm.page" :default-page-size="20"
...
const getList = async () => {
  const res = await api.getPromoters(searchForm.value);
  if (res.errorCode=='') {
